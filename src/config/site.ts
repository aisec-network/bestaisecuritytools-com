...
export const portfolio: SisterSite[] = [
  { domain: "adversarialml.dev", url: "https://adversarialml.dev", title: "Adversarial ML", tagline: "Curated tools for defending AI systems." },
...
export const siteConfig: SiteConfig = {
  domain: "bestaisecuritytools.com",
  url: "https://bestaisecuritytools.com",
  title: "Best AI Security Tools",
  tagline: "Comparing the AI security tooling landscape, with numbers.",
  description:
    "Honest comparisons of AI security products and tools — scanners, guardrails, red-team frameworks, eval harnesses. We deploy them against real attack libraries, measure detection rates and false-positive rates, and publish the numbers. Including the inconvenient ones the vendor would rather we didn't.",
  byline: "Best AI Security Tools Editorial",
  language: "en",
  locale: "en_US",
  themeColor: "#0a0a0a",
  brand: { accentHue: 60, cluster: "defensive" },
  social: { rss: "/rss.xml" },
  email: {
    contact: "hello@bestaisecuritytools.com",
    abuse: "abuse@bestaisecuritytools.com",
    editor: "editor@bestaisecuritytools.com",
  },
  ...
  sister: portfolio.filter((s) => s.domain !== "bestaisecuritytools.com"),
  analytics: {},
};
